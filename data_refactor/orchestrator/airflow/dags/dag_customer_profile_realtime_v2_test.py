...
JOB_NAME = 'customer-profile-realtime-v2-full'
...
dataflow_job = BeamRunPythonPipelineOperator(
    ...
    # py_file='{{ var.value.bucket_composer }}/dataflow/scripts/customer_profile_realtime_pipeline_full_script.py',
    # data/processor/dataflow/scripts/customer_profile_realtime_pipeline_v2.py
    py_file='{{ var.value.bucket_composer }}/dataflow/scripts/customer_profile_realtime_pipeline_v2.py',
    ...
    pipeline_options={
        ...
        'sdk_container_image': '{{ var.value.dataflow_common_image_v2 }}',
    ...
    py_requirements=[
        ...
        '/home/airflow/gcs/dags/packages/dataflow_common_v2-2.0.0-py3-none-any.whl',
    ],
