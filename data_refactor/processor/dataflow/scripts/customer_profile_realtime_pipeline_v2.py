"""
Customer Profile Realtime Streaming Pipeline - Using dataflow_common_v2 v2.0.0

This script uses the refactored dataflow_common_v2 module with PTransform pattern.
...
# =============================================================================
# IMPORT FROM DATAFLOW_COMMON_v2 v2.0.0
# =============================================================================
from dataflow_common_v2.steps import (
    # Mapping
...
from dataflow_common_v2.dofns import (
    # DLQ
    apply_with_dlq,
    # DoFns
...
def create_pipeline(pipeline_options: PipelineOptions):
    """Create and return the streaming pipeline using dataflow_common_v2 PTransforms."""

    LOGGER.info("=" * 60)
    LOGGER.info("Customer Profile Realtime Pipeline - Using dataflow_common_v2 v2.0.0")
